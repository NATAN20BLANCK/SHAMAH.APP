      ...
      const personalizedContent: BlogPost[] = [
        {
          ...
          excerpt: 'Guia personalizado criado especificamente para você',
        ...
        },
        {
          ...
          excerpt: 'Tendências futuras personalizadas baseadas em IA',
          category: 'Tendências',
          ...
          difficulty: userPreferences.skillLevel,
          source: 'ai',
          platform: (trendingTopics[0]?.platform as Platform) || 'general',
          isPersonalized: true,
          relevanceScore: 92,
          engagement: {
            likes: 0,
